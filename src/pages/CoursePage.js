            ...
            >
              ...
              <div className="p-4 text-black/[0.9]">
                ...
                <div className="absolute right-0 bottom-0 mt-2 ">
                  {item.status ? <button className="rounded bg-blue-500 text-white px-3 py-1  hover:bg-blue-600" >
                    Enroll Now
                    </button> :
                     <button className="rounded bg-blue-500 text-white px-3 py-1 hover:bg-blue-600">Coming Soon ...</button>}
                </div>
              </div>
            </div>
            </Link>
