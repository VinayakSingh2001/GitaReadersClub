...
import { useEffect } from "react";
import { auth,app } from "../../firebase.config";
import { getDatabase,getAuth,ref,get,set, update,remove } from "firebase/database";
import { getStorage, ref as storageRef, uploadBytes, getDownloadURL } from "firebase/storage";
import { toast } from "react-toastify";
import Logout from "../../components/Logout";
        ...
        try {
            ...
            if (snapshot.exists()) {
                ...
                try {
                    ...
                    console.error("Error deleting existing profile photo:", removeError);
                }
            } else {
                console.log("No existing profile photo found.");
            }
              ...
              <div>
                <div className="profile-photo flex justify-center pt-10">
                  <div className="w-60 h-60 rounded-full overflow-hidden bg-gray-500 flex items-center justify-center">
                    <img src={profileImage} className="w-full h-full object-cover" alt="Profileimg" />
